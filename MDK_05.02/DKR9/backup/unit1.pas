...
procedure TForm1.NexttClick(Sender: TObject);
begin
 editdata(cur_row);
...
procedure TForm1.PrevioussClick(Sender: TObject);
begin
 editdata(cur_row);
 if cur_row > 0 then
    begin
...
procedure TForm1.GetRow(i: integer);
var str: string;
begin
   str := Data.Strings[i];
...
procedure TForm1.editdata(i:integer);
var str:string;
begin
